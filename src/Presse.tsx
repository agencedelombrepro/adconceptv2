...
const pressArticles = [
  ...
  },
  {
    ...
    headline: 'Magnifier le patrimoine immobilier azuréen',
    subheadline: 'Résidence Saint-Michel Valetta, Cannes · Propriété à Opio',
    excerpt:
      "Deux réalisations d'exception signées Christine Thémélidis. À Cannes, la fusion de deux appartements en un vaste 220 m² au 7ème étage de la résidence Saint-Michel Valetta — terrasse en angle à 180° sur le Cap d'Antibes, La Croisette et Monaco, sols en marbre Calacatta, ascenseur privatif. À Opio, la transformation totale d'une propriété de 600 m² sur 3 hectares : extension du séjour avec trois arches vitrées en métal corten, pool house en bambous XXL, terrasses et jardins méditerranéens. Une maîtrise d'œuvre complète, du concept à la réception.",
    image: '/projects/villa-opio/opio-3.jpg',
    color: '#5A4E38',
    featured: false,
    stats: { surface: '220 m² · 600 m²', location: 'Cannes & Opio', mission: 'Rénovation & Maîtrise d\'œuvre' },
  ...
  },
  {
    ...
    issue: 'N° 45',
    year: '2020',
    category: 'Duplex & Rénovation',
    headline: 'Duplex cannois',
    subheadline: 'Architecte d\'intérieur — Cannes',
    excerpt:
      'Christine Thémélidis signe la transformation d\'un duplex à Cannes : une rénovation complète alliant volumes généreux, matériaux nobles et savoir-faire en maîtrise d\'œuvre. Un projet emblématique de l\'identité AD Concept, publié dans le magazine Perspective N°45.',
    image: "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES3.png",
    color: '#5A4E38',
    featured: false,
    stats: { surface: 'Duplex', location: 'Cannes', mission: 'Rénovation complète' },
    pdfUrl: '/presse/perspective-n45.pdf',
    readUrl: 'https://www.magazine-perspective.com',
    gallery: [
      "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES1.png",
      "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES2.png",
      "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES3.png",
      "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES4.png",
      "/DUPLEX CANNOIS ARCHITECTE INTERIEUR CANNES5.png",
...
const mediaLogos = [
  { name: 'Perspective', tagline: 'Magazine architecture & design', issues: '4 parutions' },
